<%-- 
    Document   : AddType
    Created on : Apr 10, 2017, 8:13:21 PM
    Author     : LICH
--%>
        ...
        <div class="main">
            <section id="content">
                <article class="col2 pad_left1">
                    <h2>Please fill the type form </h2>

                    <form id="ContactForm" name="myForm" action="/CS5800/AddType" method="post">
                        <div>
                            <div class="wrapper">
                                <div class="bg">
                            ...
                            <div class="wrapper">
                                <div class="bg">
                                    <input type="text" name="seatNum" class="input" required>
                                </div>
                                *How many seats:<br />
                            </div>
                            <div class="wrapper">
                                <div class="bg">
                                    <input type="text" name="speed" class="input" required>
                                </div>
                                *Max Speed:<br />
                            </div>
                            <div class="wrapper">
                            ...
                            <div class="wrapper">
                                <div class="bg">
                                    <input type="text" name="eco" class="input" required>
                                </div>
                                *seats for economic class:<br />
                            </div>
                            <div class="wrapper">
                                <div class="bg">
                                    <input type="text" name="bus" class="input" required>
                                </div>
                                *seats for business class:<br />
                            </div>
                            <div class="wrapper">
                                <div class="bg">
                                    <input type="text" name="first" class="input" required>
                                </div>
                                *seats for first class:<br />
                            </div>
