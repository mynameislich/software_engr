...
CREATE TABLE flight(flight_id VARCHAR(20), arrivingTime date, departingTime date, origin VARCHAR(20), destinationa VARCHAR(20), airplane_id VARCHAR(20), price float, frequency VARCHAR(20));
